...
<x-guest-layout>
    <div class="mb-4 text-center">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Login ke Sistem</h2>
        <p class="text-sm text-gray-600 dark:text-gray-400">Silakan masukkan email dan password Anda.</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-6">
            ...
            <x-primary-button class="ml-3 bg-green-600 hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:ring-green-500">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
